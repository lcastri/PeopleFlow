...
def plot_boxplot(data, title, ylabel, categories, background = False, outdir = None):
    ...
    plt.boxplot(
        [np.asarray(data[bag][title], dtype=float).ravel().tolist() for bag in BAGNAMES],
